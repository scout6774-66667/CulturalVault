...
export default function LandingPage() {
  return (
    <main className="min-h-[calc(100vh-4rem)] bg-background relative overflow-hidden flex flex-col justify-center items-center">
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 flex flex-col items-center text-center animate-fade-in-up">
        ...
        <h1 className="text-5xl sm:text-7xl font-extrabold tracking-tight text-foreground mb-8">
        ...
        <p className="text-xl sm:text-2xl text-muted-foreground max-w-3xl mb-12 leading-relaxed">
      ...
      <div className="absolute top-1/2 left-1/4 w-[500px] h-[500px] bg-primary/20 blur-[150px] rounded-full pointer-events-none -translate-x-1/2 -translate-y-1/2 z-0" />
      <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-secondary/20 blur-[150px] rounded-full pointer-events-none translate-x-1/2 z-0" />
    </main>
  );
}
